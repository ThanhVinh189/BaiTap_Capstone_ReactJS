...
import CreateShowtimes from "../pages/AdminTemplate/CreateShowtimes";
...
const routes = [
  {
    ...
    children: [
      ...
      { path: "dat-ve/:maLichChieu", element: <BookingMovie /> },
      { path: "list-movie", element: <ListMoviePage /> },
      { path: "dangnhap", element: <LoginUser /> },
      { path: "dangky", element: <RegisterUser /> },
      { path: "detail/:id", element: <DetailMoviePage /> },
      { path: "danh-sach-rap", element: <TabMovie /> },
    ],
  },
  {
    path: "admin",
    ...
    children: [
      { path: "movie-list", element: <MoviesPageList /> },
      { path: "add-user", element: <AddUserPage /> },
      { path: "update-user/:taiKhoan", element: <UpdateUserPage /> },
      { path: "users", element: <UsersPage /> },
      { path: "add-movie", element: <AddMoviePage /> },
      { path: "update-movie/:id", element: <UpdateMoviePage /> },
      { path: "showtime/:maPhim", element: <CreateShowtimes /> },
      { path: "thong-tin-ca-nhan", element: <Profile /> },
    ],
  },
